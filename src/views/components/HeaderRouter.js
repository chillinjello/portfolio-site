...
import Marquez_LoveInTheTimeOfCholera from '../Writing/Books/BookPages/Authors/Gabriel Garcia Marquez/LoveInTheTimeOfCholera';
import Homer_Iliad from '../Writing/Books/BookPages/Authors/Homer/Iliad';
import JohnWilliams_Stoner from '../Writing/Books/BookPages/Authors/John Williams/Stoner';
    ...
    return (
        <div>
            ...
            <Routes>
                ...
                <Route path="/books/homer-iliad" exact element={<Homer_Iliad />}></Route>
                ...
                <Route path="/books/marquez-love-in-the-time-of-cholera" exact element={<Marquez_LoveInTheTimeOfCholera/>}></Route>
                ...
                <Route path="/books/williams-stoner" exact element={<JohnWilliams_Stoner />}></Route>
